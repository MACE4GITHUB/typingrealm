...
#pragma warning restore S3963, CA1810
        ...
        public static string GenerateJwtAccessToken(string subClaimValue)
        {
            ...
            return _tokenHandler.WriteToken(new JwtSecurityToken(Issuer, AuthenticationConfiguration.Audience, claims, null, DateTime.UtcNow.AddMinutes(1), _signingCredentials));
        }
    }
}
