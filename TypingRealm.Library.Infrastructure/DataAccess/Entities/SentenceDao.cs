...
public class SentenceDao : IDao<SentenceDao>
{
    ...
    [Key]
    [MaxLength(SentenceId.MaxLength)]
    ...
    {
        return new Sentence(new(BookId), new(Id), Type, IndexInBook, Value, Words.Select(dao => dao.FromDao()).ToList());
    }
...
public class WordDao
{
    ...
    [MaxLength(Sentences.SentenceId.MaxLength)]
