...
namespace TypingRealm.Data.Infrastructure.Migrations
{
    ...
    [Migration("20211213132559_AddConfigurationToText")]
    partial class AddConfigurationToText
    {
            ...
            modelBuilder.Entity("TypingRealm.Data.Infrastructure.DataAccess.Entities.Text", b =>
                {
                    ...
                    b.Property<int?>("GenerationTextType")
                        .HasColumnType("integer")
                        .HasColumnName("generation_text_type");
